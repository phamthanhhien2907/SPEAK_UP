...
import Topic from "./src/models/Topic"; // New Topic model
...
const seed = async () => {
    ...
    // Create lessons (top-level lessons under topics)
    const lessonsData: ILessonInput[] = [
        // Ending Sounds lessons
        ...(() => {
        ...
        // Vowel Sounds lessons (split into /iː/ vs /ɪ/ and /æ/, /ʌ/, /ɑː/)
        ...(() => {
        ...
        // Consonant Sounds lessons (split into /ð/ vs /θ/ and /r/, /z/, /ʃ/)
        ...(() => {
    ...
    const endingSoundWords: EndingSoundWords = {
        "/p/": [{ correct: "stop", wrong: "stock" }, { correct: "map", wrong: "mat" }, { correct: "cap", wrong: "cat" }, { correct: "lip", wrong: "lit" }, { correct: "sip", wrong: "sit" }],
        "/b/": [{ correct: "web", wrong: "wet" }, { correct: "club", wrong: "clue" }, { correct: "job", wrong: "jog" }, { correct: "cab", wrong: "cap" }, { correct: "rib", wrong: "rip" }],
        "/t/": [{ correct: "cat", wrong: "cap" }, { correct: "hat", wrong: "hot" }, { correct: "mat", wrong: "map" }, { correct: "bat", wrong: "bad" }, { correct: "sit", wrong: "sip" }],
        "/d/": [{ correct: "bed", wrong: "bet" }, { correct: "red", wrong: "rat" }, { correct: "sad", wrong: "sat" }, { correct: "mad", wrong: "mat" }, { correct: "kid", wrong: "kit" }],
        "/k/": [{ correct: "back", wrong: "bag" }, { correct: "lock", wrong: "log" }, { correct: "sick", wrong: "sit" }, { correct: "duck", wrong: "dock" }, { correct: "kick", wrong: "kit" }],
        "/g/": [{ correct: "dog", wrong: "dot" }, { correct: "bag", wrong: "bat" }, { correct: "pig", wrong: "pit" }, { correct: "fog", wrong: "log" }, { correct: "bug", wrong: "but" }],
        "/f/": [{ correct: "leaf", wrong: "leave" }, { correct: "roof", wrong: "room" }, { correct: "off", wrong: "of" }, { correct: "safe", wrong: "save" }, { correct: "elf", wrong: "else" }],
        "/v/": [{ correct: "love", wrong: "live" }, { correct: "dove", wrong: "dive" }, { correct: "give", wrong: "gift" }, { correct: "live", wrong: "leave" }, { correct: "wave", wrong: "wage" }],
        "/θ/": [{ correct: "bath", wrong: "bat" }, { correct: "path", wrong: "pat" }, { correct: "teeth", wrong: "teethe" }, { correct: "math", wrong: "mat" }, { correct: "truth", wrong: "true" }],
        "/ð/": [{ correct: "this", wrong: "these" }, { correct: "that", wrong: "hat" }, { correct: "with", wrong: "wit" }, { correct: "mother", wrong: "mutter" }, { correct: "father", wrong: "farther" }],
        "/s/": [{ correct: "bus", wrong: "buzz" }, { correct: "kiss", wrong: "kit" }, { correct: "miss", wrong: "mix" }, { correct: "class", wrong: "clash" }, { correct: "dress", wrong: "drew" }],
        "/z/": [{ correct: "zoo", wrong: "sue" }, { correct: "buzz", wrong: "bus" }, { correct: "nose", wrong: "noose" }, { correct: "rose", wrong: "rows" }, { correct: "jazz", wrong: "jar" }],
        "/ʃ/": [{ correct: "fish", wrong: "fit" }, { correct: "wish", wrong: "wit" }, { correct: "dish", wrong: "dip" }, { correct: "rush", wrong: "rut" }, { correct: "brush", wrong: "brut" }],
        "/ʒ/": [{ correct: "beige", wrong: "badge" }, { correct: "garage", wrong: "garbage" }, { correct: "measure", wrong: "mature" }, { correct: "pleasure", wrong: "pressure" }, { correct: "treasure", wrong: "tressure" }],
        "/h/": [{ correct: "hat", wrong: "hot" }, { correct: "hit", wrong: "hot" }, { correct: "hot", wrong: "hat" }, { correct: "hope", wrong: "hop" }, { correct: "house", wrong: "hose" }],
        "/tʃ/": [{ correct: "church", wrong: "search" }, { correct: "watch", wrong: "wash" }, { correct: "catch", wrong: "cash" }, { correct: "match", wrong: "mash" }, { correct: "teach", wrong: "teak" }],
        "/dʒ/": [{ correct: "judge", wrong: "jut" }, { correct: "age", wrong: "ache" }, { correct: "page", wrong: "pace" }, { correct: "cage", wrong: "cake" }, { correct: "edge", wrong: "etch" }],
        "/m/": [{ correct: "room", wrong: "root" }, { correct: "team", wrong: "teat" }, { correct: "dream", wrong: "dread" }, { correct: "arm", wrong: "art" }, { correct: "him", wrong: "hit" }],
        "/n/": [{ correct: "sun", wrong: "sum" }, { correct: "run", wrong: "rum" }, { correct: "fun", wrong: "funny" }, { correct: "man", wrong: "mat" }, { correct: "pin", wrong: "pit" }],
        "/ŋ/": [{ correct: "sing", wrong: "sin" }, { correct: "ring", wrong: "rang" }, { correct: "song", wrong: "son" }, { correct: "king", wrong: "kin" }, { correct: "wing", wrong: "win" }],
    };

    const iSoundWords = {
        "/iː/": [{ correct: "see", wrong: "sit" }, { correct: "tree", wrong: "trip" }, { correct: "green", wrong: "grin" }, { correct: "deep", wrong: "dip" }, { correct: "feet", wrong: "fit" }],
        "/ɪ/": [{ correct: "sit", wrong: "see" }, { correct: "bit", wrong: "beat" }, { correct: "hit", wrong: "heat" }, { correct: "lip", wrong: "leap" }, { correct: "fit", wrong: "feet" }],
    };

    const aSoundWords = {
        "/æ/": [{ correct: "cat", wrong: "cut" }, { correct: "hat", wrong: "hot" }, { correct: "bat", wrong: "but" }, { correct: "map", wrong: "mop" }, { correct: "sad", wrong: "sod" }],
        "/ʌ/": [{ correct: "cup", wrong: "cap" }, { correct: "but", wrong: "bat" }, { correct: "cut", wrong: "cat" }, { correct: "sun", wrong: "son" }, { correct: "run", wrong: "ran" }],
        "/ɑː/": [{ correct: "car", wrong: "core" }, { correct: "far", wrong: "four" }, { correct: "star", wrong: "store" }, { correct: "bar", wrong: "bore" }, { correct: "hard", wrong: "heard" }],
    };
    ...
    const rzsSoundWords = {
        "/r/": [{ correct: "red", wrong: "led" }, { correct: "run", wrong: "lung" }, { correct: "rat", wrong: "lat" }, { correct: "rose", wrong: "lose" }, { correct: "rain", wrong: "lane" }],
        "/z/": [{ correct: "zoo", wrong: "sue" }, { correct: "buzz", wrong: "bus" }, { correct: "nose", wrong: "noose" }, { correct: "rose", wrong: "rows" }, { correct: "jazz", wrong: "jar" }],
        "/ʃ/": [{ correct: "fish", wrong: "fit" }, { correct: "wish", wrong: "wit" }, { correct: "dish", wrong: "dip" }, { correct: "rush", wrong: "rut" }, { correct: "brush", wrong: "brut" }],
    };

    const intonationWords = [
        { correct: "yes", wrong: "yet" }, { correct: "no", wrong: "now" }, { correct: "hello", wrong: "halo" },
        { correct: "goodbye", wrong: "goodly" }, { correct: "sorry", wrong: "sorely" },
    ];

    const longerWordsData = [
        { correct: "beautiful", wrong: "beauty" }, { correct: "education", wrong: "educate" },
        { correct: "information", wrong: "inform" }, { correct: "technology", wrong: "technical" },
    ...
    // Track words by lessonId to allow reuse across lessons
    ...
    for (const lesson of lessons) {
        ...
        // Sort by pairOrder to ensure correct/wrong pairs are adjacent
        vocabWords.sort((a, b) => a.pairOrder - b.pairOrder);

        // Add vocabulary to data, ensuring no duplicates within the same lesson
