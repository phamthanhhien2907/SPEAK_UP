...
- Name: Chat Page >> login with valid credentials then make a chat with you decide topic
- Location: D:\DATN\client\src\pages\(User)\Chat\index.spec.ts:44:5
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at D:\DATN\client\src\pages\(User)\Chat\index.spec.ts:49:28
```
