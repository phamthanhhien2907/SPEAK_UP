...
- Name: Chat Page >> login with valid credentials then make a chat with interesting topic
- Location: D:\DATN\client\src\pages\(User)\Chat\index.spec.ts:26:5
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at D:\DATN\client\src\pages\(User)\Chat\index.spec.ts:31:28
```
