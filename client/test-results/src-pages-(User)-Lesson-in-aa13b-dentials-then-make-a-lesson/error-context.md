...
- Name: Lesson Page >> login with valid credentials then make a lesson
- Location: D:\DATN\client\src\pages\(User)\Lesson\index.spec.ts:8:5
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at D:\DATN\client\src\pages\(User)\Lesson\index.spec.ts:13:28
```
