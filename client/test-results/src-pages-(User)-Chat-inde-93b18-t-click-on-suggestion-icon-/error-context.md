...
- Name: Chat Page >> login with valid credentials then make a chat click on suggestion icon 
- Location: D:\DATN\client\src\pages\(User)\Chat\index.spec.ts:134:5
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at D:\DATN\client\src\pages\(User)\Chat\index.spec.ts:139:28
```
