...
- Name: Speech Page >> Login with valid credentials then go to Home page select ordering and press button translate 
- Location: D:\DATN\client\src\pages\(User)\Speech\index.spec.ts:24:5
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at D:\DATN\client\src\pages\(User)\Speech\index.spec.ts:29:28
```
