...
- Name: Speech Page >> Login with valid credentials then go to Home page select ordering and press button repeat
- Location: D:\DATN\client\src\pages\(User)\Speech\index.spec.ts:8:5
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at D:\DATN\client\src\pages\(User)\Speech\index.spec.ts:14:28
```
...
> 14 |         await expect(page).toHaveURL('http://localhost:5173/');
  ...
  20 |         await page.waitForTimeout(5000); // Đợi 7 giây
  21 |
  22 |     });
  23 |
  ...
  35 |         await page.waitForTimeout(10000); // Đợi 7 giây
  36 |     });
  37 |
  38 |
  39 |
  ...
  53 |         await page.waitForTimeout(10000); // Đợi 7 giây
  54 |
  55 |
  56 |
  57 |     });
  ...
  73 |         await page.waitForTimeout(10000); // Đợi 7 giây
  74 |
  75 |
  76 |     });
  77 |
  ...
  94 |         await page.waitForTimeout(10000); // Đợi 7 giây
  95 |
  96 |
  97 |     });
  98 | });
