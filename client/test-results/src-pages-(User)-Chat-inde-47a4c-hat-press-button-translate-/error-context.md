...
- Name: Chat Page >> login with valid credentials then make a chat press button translate 
- Location: D:\DATN\client\src\pages\(User)\Chat\index.spec.ts:79:5
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at D:\DATN\client\src\pages\(User)\Chat\index.spec.ts:84:28
```
