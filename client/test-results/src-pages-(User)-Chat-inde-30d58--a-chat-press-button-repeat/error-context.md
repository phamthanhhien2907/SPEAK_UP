...
- Name: Chat Page >> login with valid credentials then make a chat press button repeat
- Location: D:\DATN\client\src\pages\(User)\Chat\index.spec.ts:63:5
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at D:\DATN\client\src\pages\(User)\Chat\index.spec.ts:69:28
```
