...
- Name: Speech Page >> Login with valid credentials then go to Home page select ordering press chat 
- Location: D:\DATN\client\src\pages\(User)\Speech\index.spec.ts:59:5
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at D:\DATN\client\src\pages\(User)\Speech\index.spec.ts:64:28
```
