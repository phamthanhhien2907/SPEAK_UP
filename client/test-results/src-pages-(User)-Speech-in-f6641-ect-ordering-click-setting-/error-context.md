...
- Name: Speech Page >> Login with valid credentials then go to Home page select ordering click setting 
- Location: D:\DATN\client\src\pages\(User)\Speech\index.spec.ts:40:5
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at D:\DATN\client\src\pages\(User)\Speech\index.spec.ts:45:28
```
