...
import { apiUpdateProgressTracking } from "@/services/progress-tracking.services";
...
export const EditProgressTrackingModal = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    const res = await apiUpdateProgressTracking(progressTracking?._id, {
      ...values,
  ...
  useEffect(() => {
    if (progressTracking) {
      form.setValue("totalScore", progressTracking.totalScore);
      form.setValue("userId", progressTracking.userId?._id);
      form.setValue("completedLessons", progressTracking.completedLessons);
    }
